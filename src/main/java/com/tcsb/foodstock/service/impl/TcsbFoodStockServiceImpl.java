package com.tcsb.foodstock.service.impl;
...
@Service("tcsbFoodStockService")
@Transactional
public class TcsbFoodStockServiceImpl extends CommonServiceImpl implements TcsbFoodStockServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TcsbFoodStockEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(TcsbFoodStockEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(TcsbFoodStockEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(TcsbFoodStockEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("stock_type", t.getStockType());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TcsbFoodStockEntity t){
 		sql  = sql.replace("#{id}",String.valueOf(t.getId()));
 		sql  = sql.replace("#{stock_type}",String.valueOf(t.getStockType()));
