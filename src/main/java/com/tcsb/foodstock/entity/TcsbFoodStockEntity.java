package com.tcsb.foodstock.entity;
 ...
 */
@Entity
@Table(name = "tcsb_food_stock", schema = "")
@SuppressWarnings("serial")
public class TcsbFoodStockEntity implements java.io.Serializable {
	/**id*/
	 ...
	 */
	@Column(name ="STOCK_TYPE",nullable=true,length=1)
	 ...
	 */
	@Column(name ="STOCK",nullable=true,length=10)
