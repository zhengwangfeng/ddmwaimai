package com.tcsb.distributionscope.entity;
 ...
 */
@Entity
@Table(name = "tcsb_distribution_scope", schema = "")
@SuppressWarnings("serial")
public class TcsbDistributionScopeEntity implements java.io.Serializable {
	/**id*/
	 ...
	 *@return: java.lang.Double  配送公里数
	 */
	@Column(name ="MILEAGE",nullable=true,length=22)
