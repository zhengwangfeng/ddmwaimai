package com.weixin.weixinnewsitem.service.impl;
...
@Transactional
public class WeixinNewsitemServiceImpl extends CommonServiceImpl implements WeixinNewsitemServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WeixinNewsitemEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(WeixinNewsitemEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(WeixinNewsitemEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(WeixinNewsitemEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("new_type", t.getNewType());
		...
		map.put("template_id", t.getWeixinNewstemplateEntity().getId());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WeixinNewsitemEntity t){
 		sql  = sql.replace("#{id}",String.valueOf(t.getId()));
 		sql  = sql.replace("#{new_type}",String.valueOf(t.getNewType()));
 		...
 		sql  = sql.replace("#{template_id}",String.valueOf(t.getWeixinNewstemplateEntity().getId()));
