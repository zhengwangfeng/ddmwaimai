...
public class MessageTest {
	...
	public void testuploadmedia() {
		...
		JwSendMessageAPI service = new JwSendMessageAPI();
		try {
			WxMediaResponse r = JwSendMessageAPI.uploadMediaFile(newAccessToken, "F:\\img\\", "showqrcode.jpg", "image");
			System.out.println(r);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public void testuploadnews() {
		...
		try {
			...
			WxArticlesResponse result = JwSendMessageAPI.uploadArticles(newAccessToken, wxArticles);
