...
//		t.getUserShareHour();
	...
	public void getUserSummary() throws WexinReqException{
		...
		List<UserAnalysisRtnInfo> userAnalysisList = JwUserAnalysisAPI.getUserSummary(getAccessToken(), "2015-01-27", "2015-01-30");
	...
	public void getUserCumulate() throws WexinReqException{
		JwUserAnalysisAPI jua = new JwUserAnalysisAPI();
		List<UserAnalysisRtnInfo> userAnalysisRtnInfoList = JwUserAnalysisAPI.getUserCumulate(getAccessToken(), "2015-01-24", "2015-01-30");
	...
	public void getArticleSummary() throws WexinReqException, UnsupportedEncodingException{
		...
		List<GraphicAnalysisRtnInfo> graphicAnalysisRtnInfoList = JwGraphicAnalysisAPI.getArticleSummary(getAccessToken(), "2015-03-02", "2015-03-02");
	...
	public void getArticleTotal() throws WexinReqException, UnsupportedEncodingException{
		JwGraphicAnalysisAPI jga = new JwGraphicAnalysisAPI();
		List<GraphicAnalysisRtnInfo> graphicAnalysisRtnInfoList = JwGraphicAnalysisAPI.getArticleTotal(getAccessToken(), "2015-03-03", "2015-03-03");
	...
	public void getUserRead() throws WexinReqException{
		JwGraphicAnalysisAPI jga = new JwGraphicAnalysisAPI();
		List<GraphicAnalysisRtnInfo> graphicAnalysisRtnInfoList = JwGraphicAnalysisAPI.getUserRead(getAccessToken(), "2015-01-29", "2015-01-30");
	...
	public void getUserReadHour() throws WexinReqException{
		JwGraphicAnalysisAPI jga = new JwGraphicAnalysisAPI();
		List<GraphicAnalysisRtnInfo> graphicAnalysisRtnInfoList = JwGraphicAnalysisAPI.getUserReadHour(getAccessToken(), "2015-01-30", "2015-01-30");
	...
	public void getUserShare() throws WexinReqException{
		JwGraphicAnalysisAPI jga = new JwGraphicAnalysisAPI();
		List<GraphicAnalysisRtnInfo> graphicAnalysisRtnInfoList = JwGraphicAnalysisAPI.getUserShare(getAccessToken(), "2015-01-24", "2015-01-30");
	...
	public void getUserShareHour() throws WexinReqException{
		JwGraphicAnalysisAPI jga = new JwGraphicAnalysisAPI();
		List<GraphicAnalysisRtnInfo> graphicAnalysisRtnInfoList = JwGraphicAnalysisAPI.getUserShareHour(getAccessToken(), "2015-01-30", "2015-01-30");
