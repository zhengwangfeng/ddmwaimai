...
public class JwDataCubeAPI {
	...
	private static void getWxDataCubeStreamMsgInfo(){
		...
		try {
			List<WxDataCubeStreamMsgInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2015-01-01","2015-01-07");
	...
	private static void testGetWxDataCubeStreamMsgHourInfo(){
		...
		JwDataCubeAPI s = new JwDataCubeAPI();
		try {
			List<WxDataCubeStreamMsgHourInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgHourInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2015-01-07","2015-01-07");
			if(msgInfoList!=null&&msgInfoList.size()>0){
	...
	private static void testGetWxDataCubeStreamMsgWeekInfo(){
		...
		JwDataCubeAPI s = new JwDataCubeAPI();
		try {
			List<WxDataCubeStreamMsgWeekInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgWeekInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2015-01-01","2015-01-07");
			if(msgInfoList!=null&&msgInfoList.size()>0){
	...
	private static void testGetWxDataCubeStreamMsgMonthInfo(){
		...
		JwDataCubeAPI s = new JwDataCubeAPI();
		try {
			List<WxDataCubeStreamMsgMonthInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgMonthInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2014-01-01","2015-01-30");
			if(msgInfoList!=null&&msgInfoList.size()>0){
	...
	private static void testGetWxDataCubeStreamMsgDistInfo(){
		...
		JwDataCubeAPI s = new JwDataCubeAPI();
		try {
			List<WxDataCubeStreamMsgDistInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgDistInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2015-01-01","2015-01-15");
			if(msgInfoList!=null&&msgInfoList.size()>0){
	...
	private static void testGetWxDataCubeStreamMsgDistWeekInfo(){
		...
		JwDataCubeAPI s = new JwDataCubeAPI();
		try {
			List<WxDataCubeStreamMsgDistWeekInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgDistWeekInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2015-01-01","2015-01-15");
			if(msgInfoList!=null&&msgInfoList.size()>0){
	...
	private static void testGetWxDataCubeStreamMsgDistMonthInfo(){
		...
		JwDataCubeAPI s = new JwDataCubeAPI();
		try {
			List<WxDataCubeStreamMsgDistMonthInfo> msgInfoList = JwDataCubeAPI.getWxDataCubeStreamMsgDistMonthInfo("a8UEhkxmxN269afPJ7SuY9vVroHPYiwm9Yv5gu_yK4GGsA60IafJ3N9We4ubabgZ4lsl4kd0zqcH7JC70UsQ951Ndur4ejSIz7VvroBJn4g","2015-01-01","2015-01-15");
			if(msgInfoList!=null&&msgInfoList.size()>0){
