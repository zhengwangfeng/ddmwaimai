    ...
    <script type="text/javascript">  
        ...
        function connect() {  
            ...
            if ('WebSocket' in window) {  
                ws= new WebSocket("ws://localhost:8080/jeecgos/rest/websck");  
                console.log("ws://localhost:8080/jeecgos/rest/websck");  
            }else {  
                ws = new SockJS("http://localhost:8080/jeecgos/rest/sockjs/websck");  
                console.log("http://localhost:8080/jeecgos/rest/sockjs/websck"); 
            }  
