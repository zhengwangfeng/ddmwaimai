...
$(function () {
    ...
    var url = 'weixinNewsitemController.do?uploadImg',
        uploadButton = $('<button/>')
    ...
    $('#fileupload').fileupload({
        ...
        $("#saveButton").click(function(){
            ...
            $("#formobjNew").attr("action", "weixinNewsitemController.do?doUpdate");
        	$("#formobjNew").submit();
 ...
 <body>
 	<div class="main_bd">
					...
					<div class="appmsg_content" id="js_appmsg_preview">
							<h4 class="appmsg_title">
								<a target="_blank" href="javascript:void(0);"
									onclick="return false;">${weixinNewsitemPage.title}</a>
							</h4>
							<div class="appmsg_info">
								<em class="appmsg_date"></em>
							</div>
							<div id="files" class="files">
								<i style="height:160px;overflow:hidden;display:inline-block;width:100%;"><img src="${weixinNewsitemPage.image}" width="100%" height="160" /></i>
							</div>
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner">
		  		<t:formvalid formid="formobjNew" dialog="true" usePlugin="password" layout="table" action="weixinNewsitemController.do?doUpdate" tiptype="1">
							<input id="id" name="id" type="hidden" value="${weixinNewsitemPage.id }">
				<table style="width: 100%" cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
							     	 <input id="title" name="title" type="text" value="${weixinNewsitemPage.title}" style="width: 300px" class="inputxt"  datatype="*">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="author" name="author" value="${weixinNewsitemPage.author}" type="text" style="width: 300px" class="inputxt" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="image" name=image type="hidden" value="${weixinNewsitemPage.image}" datatype="*" nullmsg="请添加图片">
							    </span>
						...
						<tr>
							...
							<td class="value">
							     	 <input id="description" name="description" value="${weixinNewsitemPage.description}" type="text" style="width: 300px" class="inputxt" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
							     	 <input id="url" name="url" type="text" style="width: 300px" class="inputxt" value="${weixinNewsitemPage.url}" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="content" id="content">${weixinNewsitemPage.content}</textarea>
							    <script type="text/javascript">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="orders" name="orders" type="text" style="width: 150px" class="inputxt" value="${weixinNewsitemPage.orders}" datatype="*">
									<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/weixin/weixinnewsitem/weixinNewsitem.js"></script>		