 	...
 	<div class="main_bd">
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner">
		  		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinNewsitemController.do?doAdd" tiptype="1">
						...
						<tr>
							...
							<td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="image" name="image" type="hidden"  datatype="*" nullmsg="请添加图片">
							    </span>
