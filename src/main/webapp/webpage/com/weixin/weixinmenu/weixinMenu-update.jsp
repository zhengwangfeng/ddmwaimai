...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinMenuController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="menukey" name="menukey" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.menukey}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="msgtype" name="msgtype" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.msgtype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.name}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="orders" name="orders" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.orders}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="templateid" name="templateid" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.templateid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="type" name="type" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.type}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="fatherid" name="fatherid" type="text" style="width: 150px" class="inputxt"  value='${weixinMenuPage.fatherid}'>
							<span class="Validform_checktip"></span>
