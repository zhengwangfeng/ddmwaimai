...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinNewstemplateController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
                            ...
                            <t:dictSelect field="type" typeGroupCode="WXTW" hasLabel="false" defaultVal="common"></t:dictSelect>
							<span class="Validform_checktip"></span>
