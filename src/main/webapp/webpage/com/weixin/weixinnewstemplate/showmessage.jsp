...
<div class="cover_appmsg_item" onmouseover="mouseover('header')" onmouseout="mouseout('header')">
	...
	<div class="appmsg_thumb_wrp">
		<img class="appmsg_thumb" alt="" src="${headerNews.image}">
	</div>
...
<c:forEach items="${newsList}" var="news">
	<div class="appmsg_item" onmouseover="mouseover('item')" onmouseout="mouseout('item')">
		...
		<img class="appmsg_thumb" alt="" src="${news.image}">
		<h4 class="appmsg_title">
...
<script type="text/javascript">
	...
	function goUpate(newsId){
		var  url = 'weixinNewsitemController.do?goUpdate&id='+newsId;
		$("#showframe").attr("src",url);
	}
	
	function goDelete(newsId){
	
		var url = "weixinNewsitemController.do?doDel&id="+newsId;
		$.ajax({
			url:url,
			dataType:"JSON",
			method:"Get",
