...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="weixinUserList" checkbox="true" fitColumns="false" title="微信用户" actionUrl="weixinUserController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="备注" align="center" field="note"    queryMode="group"  width="120"></t:dgCol>
  ...
  <%-- <t:dgToolBar title="批量删除"  icon="icon-remove" url="weixinUserController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar> --%>
   ...
   <!-- 列表自定义查询条件 -->
  	  <div id="weixinUserListtd" style="padding:1px;border:1px; height:auto">
		<div name="searchColums" style=" height:45px;line-height:45px;overflow:hidden;border:1px"><input  id="_sqlbuilder" name="sqlbuilder" type="hidden" />
			<form id='customDatagridListForm'>
				...
				<input class="easyui-validatebox" id="mobile" type="text" name="mobile" style="width: 120px">	    
			</form>
		</div>
			<div style="height:30px;line-height:30px;overflow:hidden;border:1px" class="datagrid-toolbar">
				<span style="float:right">
					<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="searchWeixinUser()">查询</a>
					<a href="#" class="easyui-linkbutton" iconCls="icon-reload" onclick="Refresh('weixinUserList')">重置</a>
				</span>
			</div>
		</div>
  </div>
