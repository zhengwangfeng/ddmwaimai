...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinLinksucaiController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${weixinLinksucaiPage.name}' datatype="*">
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="outerLink" style="width:600px;" class="inputxt" rows="6" name="outerLink" datatype="*">${weixinLinksucaiPage.outerLink}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="content" style="width:600px;" class="inputxt" rows="6" name="content">${weixinLinksucaiPage.content}</textarea>
							<span class="Validform_checktip"></span>
