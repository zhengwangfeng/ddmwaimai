...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinTexttemplateController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     <input id="templatename" name="templatename" type="text" style="width: 150px" class="inputxt"  value='${weixinTexttemplatePage.templatename}'> 
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 <textarea type="text" style="width: 90%;" rows="4" name="content" value="${weixinTexttemplatePage.content}" id="content" datetype="*">${weixinTexttemplatePage.content}</textarea>
							<span class="Validform_checktip"></span>
