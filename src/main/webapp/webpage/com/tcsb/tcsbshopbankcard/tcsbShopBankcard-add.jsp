...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbShopBankcardController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="beneficiaryBankcode" name="beneficiaryBankcode" type="text" style="width: 150px" class="inputxt" >
					...
					<td class="value">
					     	 <input id="beneficiaryAccount" name="beneficiaryAccount" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="beneficiaryName" name="beneficiaryName" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="beneficiaryOpeningBankName" name="beneficiaryOpeningBankName" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="beneficiaryLineNumber" name="beneficiaryLineNumber" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="clientDerialNumber" name="clientDerialNumber" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
