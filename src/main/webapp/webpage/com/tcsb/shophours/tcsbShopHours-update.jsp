...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbShopHoursController.do?doUpdate">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<td class="value">
					<select id="shopHoursPeriodId" name="shopHoursPeriodId" datatype="*">
						...
						<c:forEach items="${tcsbShopHoursPeriodEntitys}" var="tcsbShopHoursPeriodEntity">
							<option value="${tcsbShopHoursPeriodEntity.id}" <c:if test="${tcsbShopHoursPeriodEntity.id==tcsbShopHoursPage.shopHoursPeriodId }">selected ="selected"</c:if>>${tcsbShopHoursPeriodEntity.name}</option>
			...
			<tr>
				<tr>
					...
					<td class="value">
					     	 <input id="businessHours" name="businessHours" value="${tcsbShopHoursPage.businessHours }" type="text" style="width: 150px" class="inputxt">
							<span class="Validform_checktip"></span>
