...
<div class="easyui-layout" fit="true" style="height: 500px;">
  ...
  <t:datagrid name="tcsbSettleAccountList" checkbox="false" pagination="true" fitColumns="false" title="账单结算" actionUrl="tcsbSettleAccountController.do?datagrid&shopId=${shopId }" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="店铺名称"  field="shopName"  align="center"  queryMode="group"  width="140"></t:dgCol>
   <t:dgCol title="待结算账单日期"  field="waitSettleDatas" formatter="yyyy-MM-dd" align="center" queryMode="group"  width="200"></t:dgCol>
   <t:dgCol title="结算日期"  field="settleData" align="center" queryMode="group" formatter="yyyy-MM-dd"  width="100"></t:dgCol>
   <t:dgCol title="结算金额（扣除3%手续费）"  field="total"  align="center"  queryMode="group"  width="160"></t:dgCol>
