...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbMemberTitleController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberTitlePage.name}' datatype="*">
			...
			<tr>
				...
				<td class="value">
					...
					<t:ckfinder name="img" uploadType="Images" width="100" height="60" value="${tcsbMemberTitlePage.img}" buttonClass="ui-button" buttonValue="上传图片"></t:ckfinder>
					<span class="Validform_checktip"></span>
