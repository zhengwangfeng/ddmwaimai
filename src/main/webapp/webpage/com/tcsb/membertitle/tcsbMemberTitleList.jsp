...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tcsbMemberTitleList" checkbox="true" fitColumns="false" title="会员头衔" actionUrl="tcsbMemberTitleController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="图标"  field="img"  image="true"   queryMode="group"  imageSize="120,75"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="tcsbMemberTitleController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="tcsbMemberTitleController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tcsbMemberTitleController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="tcsbMemberTitleController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="tcsbMemberTitleController.do?goUpdate" funname="detail"></t:dgToolBar>
