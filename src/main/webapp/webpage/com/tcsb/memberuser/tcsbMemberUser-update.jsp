...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbMemberUserController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="sex" name="sex" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.sex}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="province" name="province" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.province}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="city" name="city" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.city}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="country" name="country" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.country}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="headimgurl" name="headimgurl" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.headimgurl}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="privilege" name="privilege" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.privilege}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="mobile" name="mobile" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.mobile}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="note" name="note" type="text" style="width: 150px" class="inputxt"  value='${tcsbMemberUserPage.note}'>
							<span class="Validform_checktip"></span>
