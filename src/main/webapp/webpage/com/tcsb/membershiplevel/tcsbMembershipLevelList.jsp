...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tcsbMembershipLevelList" checkbox="true" fitColumns="false" title="会员级别" actionUrl="tcsbMembershipLevelController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="id"  field="id"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="会员级别名称"  field="name"    queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="所属店铺"  field="shopId"    queryMode="group"  hidden="true" width="120"></t:dgCol>
   ...
   <t:dgCol title="会员级别条件"  field="memberLevelConditionsId"   hidden="true" queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="会员级别条件"  field="memberLevelConditionsName"   queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="tcsbMembershipLevelController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="tcsbMembershipLevelController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tcsbMembershipLevelController.do?goUpdate" funname="update"></t:dgToolBar>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="tcsbMembershipLevelController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/com/tcsb/membershiplevel/tcsbMembershipLevelList.js"></script>		
