...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbFullcutTemplateController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="total" name="total" type="text" style="width: 150px" class="inputxt"  value='${tcsbFullcutTemplatePage.total}' datatype="n">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="discount" name="discount" type="text" style="width: 150px" class="inputxt"  value='${tcsbFullcutTemplatePage.discount}' datatype="n">
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="usePeriod" name="usePeriod" type="text" style="width: 150px" class="inputxt" datatype="n" value='${tcsbFullcutTemplatePage.usePeriod}'>
					     	<t:dictSelect field="dateUnit" type="select" datatype="*" 
						    typeGroupCode="dateUnit"  hasLabel="false"  title="" defaultVal="${tcsbFullcutTemplatePage.dateUnit}"></t:dictSelect>   
							<span class="Validform_checktip"></span>
