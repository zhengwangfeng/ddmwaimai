...
document.upbook.remLen.value = maxlimit - field.value.length; 
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbAssociatorStatisticsController.do?send" tiptype="1" >
		...
		<table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<!-- <textarea id="content" name="content" rows="10" cols="50" onPropertyChange= "textCounter(upbook.words, 50)"  ></textarea>
