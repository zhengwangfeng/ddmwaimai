...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbShopFullcutTemplateController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="total" name="total" type="text" style="width: 150px" class="inputxt"  value='${tcsbShopFullcutTemplatePage.total}' datatype="n">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="discount" name="discount" type="text" style="width: 150px" class="inputxt"  value='${tcsbShopFullcutTemplatePage.discount}' datatype="n">
							<span class="Validform_checktip"></span>
