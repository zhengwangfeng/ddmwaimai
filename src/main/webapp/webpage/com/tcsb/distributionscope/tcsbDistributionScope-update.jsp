...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbDistributionScopeController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="mileage" name="mileage" type="text" style="width: 150px" class="inputxt"  value='${tcsbDistributionScopePage.mileage}' datatype="/(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/" errormsg="请输入两位小数">
					...
					<tr>
						...
						<td class="value">
							 <t:dictSelect field="status" typeGroupCode="sf_yn" hasLabel="false" defaultVal="${tcsbDistributionScopePage.status}" datatype="*"></t:dictSelect>
							<span class="Validform_checktip"></span>
