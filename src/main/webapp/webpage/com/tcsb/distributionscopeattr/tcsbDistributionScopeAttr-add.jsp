...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbDistributionScopeAttrController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="beginSendMoney" name="beginSendMoney" type="text" style="width: 150px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
					     	 <input id="distributionFee" name="distributionFee" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	<!--  <input id="distributionScopeId" name="distributionScopeId" type="text" style="width: 150px" class="inputxt" > -->
							 <select id="distributionScopeId" name="distributionScopeId" datatype="*">
								<c:forEach items="${tcsbDistributionScopeEntities}" var="tcsbDistributionScopeEntitie">
									<option value="${tcsbDistributionScopeEntitie.id }">${tcsbDistributionScopeEntitie.mileage}</option>
								</c:forEach> 
							</select>
							<span class="Validform_checktip"></span>
