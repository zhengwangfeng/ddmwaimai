...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tcsbOrderList" checkbox="true" fitColumns="false" title="订单" actionUrl="tcsbOrderController.do?datagridLog" idField="id" fit="true" queryMode="group">
