...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tcsbWeixinUserController.do?doAdd" tiptype="1" >
...
>    
				...
				<tr>
					...
					<td class="value">
					     	 <input id="smscode" name="smscode" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
...
>    
					...
					<td class="value">
					     	 <input id="issale" name="issale" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
