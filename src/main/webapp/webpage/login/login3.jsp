                ...
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div>
                       <!--  <div style="float: right; margin-left:-30px; margin-right: 40px;">
                           	 <span>&copy; 点单么平台版权所有 <span class="tip"><a href="#" title=点单么商户管理系统>点单么管理系统</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#" title=厦门国通宝网络科技有限公司>厦门国通宝网络科技有限公司</a></span></span> 
                        </div> -->
                         <div class="copyright ">
					    	<span>&copy; 点单么平台版权所有 <span class="tip"><a href="#" title=点单么商户管理系统>点单么商户管理系统</a> (推荐使用IE8+,谷歌浏览器) </span></span>
					    </div>  
                    </div>
                </form>
            </div>
